...
export default function PreviewPage() {
  ...
  async function preview() {
    ...
    setResults(null);
    try {
      const data = await api.post("/preview", { source_catalog: sourceCatalog, dest_catalog: destCatalog, schema, table });
      setResults(data);
    } catch (e: any) {
        ...
        <CardContent className="pt-6">
          <div className="flex gap-4 items-end">
            ...
            <CatalogPicker
              ...
              showTable={false}
            />
            <Button onClick={preview} disabled={!sourceCatalog || !destCatalog || !schema || !table || loading}>
