...
class DSARManager:
    ...
    def submit_request(
        ...
        self.store.save_request(
            ...
            export_format=export_format or self.default_format,
    ...
    def discover_subject(self, request_id: str, subject_value: str) -> dict:
        ...
        candidates = rtbf_mgr._find_subject_columns(
    ...
    def export_data(
        self, request_id: str, subject_value: str, export_format: str | None = None
    ) -> dict:
        ...
        if fmt == "json":
            ...
            with open(path, "w") as f:
                json.dump(
                    {"request_id": request_id, "tables": all_data, "total_rows": total_rows},
                    f,
                    indent=2,
                    default=str,
                )
