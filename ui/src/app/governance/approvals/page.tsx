...
export default function ApprovalsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {certs.length === 0 ? (
        <div className="text-center py-16"><CheckCircle2 className="h-12 w-12 text-green-300 mx-auto mb-4" /><p className="text-muted-foreground">No pending approvals</p></div>
      ) : (
            ...
            <Card key={c.cert_id}>
              <CardContent className="pt-4 space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Button size="sm" onClick={() => handleAction(c.cert_id, "approve")} className="bg-green-600 hover:bg-green-700 text-white"><CheckCircle2 className="h-4 w-4 mr-1" />Approve</Button>
