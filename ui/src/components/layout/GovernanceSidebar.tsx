...
import {
  ...
  PanelLeftClose, PanelLeftOpen, UserX, Download, Lock,
} from "lucide-react";
...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { href: "/governance/rbac", label: "RBAC", icon: Lock },
    ],
  },
  {
    title: "Compliance",
...
const STORAGE_KEY = "clxs-gov-sidebar-collapsed";
...
export default function GovernanceSidebar() {
    ...
    return (
      <aside className="w-11 shrink-0 border-r border-border bg-background hidden lg:flex flex-col">
        <div className="flex flex-col items-center h-full py-2">
          <nav className="flex-1 overflow-y-auto w-full flex flex-col items-center gap-0.5 pt-1" aria-label="Governance navigation">
  ...
  return (
    <aside className="w-56 shrink-0 border-r border-border bg-background h-full flex flex-col">
      ...
      <nav className="py-2 flex-1 overflow-y-auto" aria-label="Governance navigation">
